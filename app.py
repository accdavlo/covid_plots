...
st.write("Dati disponibili giornalmente su nuovi casi, nuovi decessi, nuove terapie intensive, terapie intensive occupate e posti letto occupati") #markdown
...
newICUCases = st.sidebar.slider("Nuove terapie intensive su nuovi casi", 0.0, 0.05, 0.02/1.7,step=0.001,format="%1.3f")
